...
//	@NotNull(message = "offerName dont be null")
	...
	public SimDTO(Integer simId, String serviceNumber, String simNumber, String simStatus, Integer offerId,
			Integer callQty, Integer cost, Integer dataQty, Integer duration, String offerName) {
		super();
		this.simId = simId;
		this.serviceNumber = serviceNumber;
		this.simNumber = simNumber;
